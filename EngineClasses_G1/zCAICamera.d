...
class zCAICamera {
	...
	var int numTargets; //int // sizeof 04h offset A0h
	var string oldCamSys; //zSTRING // sizeof 14h offset A4h
	var int sysChanged; //int // sizeof 04h offset B8h
	var int playerIsMovable; //int // sizeof 04h offset BCh
	var int followIdealPos; //int // sizeof 04h offset C0h
	var int dialogCamDuration; //float // sizeof 04h offset C4h
	var int numOUsSpoken; //int // sizeof 04h offset C8h
	var int numDialogCamTakes; //int // sizeof 04h offset CCh
	var int lastNumDialogCamTakes; //int // sizeof 04h offset D0h
	var int lastDialogCamSide; //int // sizeof 04h offset D4h
	var int firstSpeakerWasPC; //int // sizeof 04h offset D8h
	var int dialogCam; //zCCSCamera* // sizeof 04h offset DCh
	var string lastPresetName; //zSTRING // sizeof 14h offset E0h
	var int raysCasted; //int // sizeof 04h offset F4h
	var int underWater; //int // sizeof 04h offset F8h
	var int inCutsceneMode; //int // sizeof 04h offset FCh
	var string debugS; //zSTRING // sizeof 14h offset 100h
	var int showPath; //int // sizeof 04h offset 114h
	var int focusVob; //zCVob* // sizeof 04h offset 118h

	var int ctrlDot[MAX_CTRL_VOBS]; //zCVob* // sizeof 140h offset 11Ch
	var int pathSearch; //zCPathSearch* // sizeof 04h offset 25Ch
	var int moveTracker; //zCMovementTracker* // sizeof 04h offset 260h
	var int evasionSearchReport; //zSPathSearchResult* // sizeof 04h offset 264h
	var string curcammode; //zSTRING // sizeof 14h offset 268h
	var int npcVolumeRangeOffset; //float // sizeof 04h offset 27Ch
	var int camDistOffset; //float // sizeof 04h offset 280h
	var int camSysFirstPos[3]; //zVEC3 // sizeof 0Ch offset 284h
	var int firstPerson; //int // sizeof 04h offset 290h
};
